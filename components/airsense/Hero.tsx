...
const statusConfig = {
  GOOD: { color: 'text-emerald-400', bg: 'bg-emerald-400/10', border: 'border-emerald-400/40', glow: 'shadow-emerald-500/20' },
  MODERATE: { color: 'text-amber-400', bg: 'bg-amber-400/10', border: 'border-amber-400/40', glow: 'shadow-amber-500/20' },
  BAD: { color: 'text-red-400', bg: 'bg-red-400/10', border: 'border-red-400/40', glow: 'shadow-red-500/20' },
};
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-grid">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto pt-24">
        ...
        >
          ...
          <br />
          <span className="text-slate-500 text-base">{t.hero.subtitleLine2}</span>
        </motion.p>
        ...
        >
          <div className={`flex flex-wrap items-center gap-3 px-6 py-3 rounded-2xl border shadow-xl ${cfg.bg} ${cfg.border} ${cfg.glow}`}>
            ...
            <span className={`text-sm font-bold tracking-widest ${cfg.color}`}>
              {t.hero.airQuality}: {t.status[status]}
            </span>
        ...
        >
          {[
            { label: t.hero.stats.activeSensors, value: '18' },
            { label: t.hero.stats.studyZones, value: '5' },
            { label: t.hero.stats.avgComfort, value: '74%' },
            { label: t.hero.stats.updateRate, value: '3s' },
          ].map(stat => (
