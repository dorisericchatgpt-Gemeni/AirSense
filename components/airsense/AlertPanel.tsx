...
export default function AlertPanel({ alerts }: AlertPanelProps) {
  ...
  return (
    <div className="fixed top-20 right-4 z-40 flex flex-col gap-2 w-72 sm:w-80">
      <AnimatePresence>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-0.5">
                    ...
                    <span className="text-slate-500 text-xs truncate">{alert.zone.split(' (')[0]}</span>
                  </div>
              ...
              return (
                <div key={alert.id} className={`glass rounded-xl p-4 border ${cfg.bg} ${cfg.border}`}>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className={`text-xs font-bold tracking-wider mb-1 ${cfg.color}`}>{cfg.label}</div>
                      <div className="text-xs text-slate-400 mb-1">{alert.zone}</div>
